...
namespace RoamingBots.Extensions
{
    ...
    public static class BotTypeUtils
    {
        ...
        public static bool IsBotEnabled(this BotType enabledTypes, BotOwner Owner)
        {
            bool bIsPlayerScav = Owner.Profile.Nickname.Contains(" (");
            if (bIsPlayerScav)
            {
                return enabledTypes.HasPlayerScav();
            }
            WildSpawnType role = Owner.Profile.Info.Settings.Role;
